...
%% Institute name and U of I workmark %%
\institute[]{\color{beamer@nihgrey}Laboratory for Epidemiology and Population Sciences \\ % use [] to not have the institute name on the footline
...
\begin{frame}
	...
	According to the United States Dept. of Agriculture (USDA) \textbf{food insecurity} (FI) is defined as: \textit{a lack of consistent access to enough food for every person in a household to live an active, healthy life.}
...
\subsection{Model Specification}
	...
	\begin{itemize}
		...
		\item Hierarchical Intrinsic Conditional Autoregressive Model (iCAR) \footlessfullcite{besag_spatial_1974}
		\begin{itemize}
